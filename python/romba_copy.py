...
def main():
    ...
    while True:
        ...
        if stop_flag != 1:
            ...
            el_st,er_st= GetEncs(ser)
            print("Enc L:"+str(el_st)+" R:"+str(er_st))
            enc_l_list=[]
            enc_l_list.append(el_st)
            enc_r_list=[]
            enc_r_list.append(er_st)
            ...
            vol = GetSensor(ser, RB_VOLTAGE, 2, False)
            cur = GetSensor(ser, RB_CURRENT, 2, False)
            enc_l_list.append(el)
            enc_r_list.append(er)
            end = time.time()
            ...
            print("OIMode:"+str(oimode))
            print("Votage/Current ="+str(vol)+"[mV]/"+str(cur)+"[mA]")
            print("time:"+str(time_diff)+"s")
            print("el_diff:"+str(el_diff)+"s")
            print("er_diff:"+str(er_diff)+"s")
