...
config = rs.config()
config.enable_stream(rs.stream.depth, 800, 480, rs.format.z16, 30)
config.enable_stream(rs.stream.color, 800, 480, rs.format.bgr8, 30)
...
#メイン処理
def object_detection_webcam2_1(key):
    # Start streaming
